...
public class JavaMLP {
  ...
  public static int numEpochs = 50000; //number of training cycles
...
//==============================================================
  ...
  public static void run(int input, int hidden, int output,
                  double[][] inputs, double[] expectedOutputs,
                  double[][] testInputs, double[][] testExpectedOutputs) {
    numInputs = input;
    numHidden = hidden;
    trainInputs = inputs;
    trainOutput = expectedOutputs;
    numPatterns = expectedOutputs.length;
    weightsIH = new double[input][hidden];
    weightsHO = new double[hidden];
    hiddenVal = new double[hidden];
